...
namespace WDList
{
    ...
    public class MyList<T> : IList<T>, System.Collections.IList
    {
        ...
        protected void OnChanged(ChangedEventArgs<T> e)
        {
            if (Changed != null)
                Changed(this, e);
        }
        ...
        public void Add(T item)
        {
            ...
            var e = new ChangedEventArgs<T>();
            e.Item = item;
            e.NewIndex = _size - 1;
            e.Type = ChangedType.AddOrInsert;
            OnChanged(e);
        }
        ...
        private void EnsureCapacity(int min)
        {
            if (_items.Length < min)
            {
                ...
                if ((uint)newCapacity > 0x7FFFFFFF) newCapacity = 0x7FFFFFFF;
        ...
        internal static IList<T> Synchronized(MyList<T> list)
        {
